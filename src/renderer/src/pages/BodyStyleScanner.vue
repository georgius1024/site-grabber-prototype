...
import BodyPreviewer from '../components/BodyStylePreviewer.vue'
const bodyStylesGrabber = window['bodyStylesGrabber']
...
const scan = async (): Promise<void> => {
  ...
  const promises = urls.value.split('\n').map((url) => bodyStylesGrabber(url.trim()))
